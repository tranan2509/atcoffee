<template>
  <admin>
    <section-header :title="title">
        ...
        <div class="breadcrumb-item active">
          <router-link to="/admin/profile">Thông tin cá nhân</router-link>
        </div>
...
export default {
  name: Constants.COMPONENT_NAME_CHANGE_PASSWORD,
  ...
  created() {
    ...
    this.$store.getters.menu.profile.submenu.change_password = true;
  }
}
</script>
...
.form-group.action input[type='submit'] {
  width: 200px;
}
</style>