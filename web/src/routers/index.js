...
import InfoStaff from '../components/view/staff/InfoStaff.vue'
...
const routes = [
  ...
  {path: '/admin/staff-info', name: 'staff-info', component: InfoStaff, meta: {title: 'A&T Coffee | Thông tin nhân viên'}},
