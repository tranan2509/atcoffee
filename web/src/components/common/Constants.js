...
export const PAGE_SIZE_STAFF = 3;
export const PAGE_SIZE_STORE = 5;
export const PAGE_SIZE_ORDER = 6;
export const PAGE_SIZE_ORDER_STATISTICS = 6;
export const PAGE_SIZE_REWARD = 5;
export const PAGE_SIZE_CATEGORY = 3;
export const PAGE_SIZE_PROMOTION = 3;
